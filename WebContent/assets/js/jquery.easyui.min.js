...
$("<span class=\"tree-hit tree-collapsed\"></span>").prependTo(node);
	...
	var _iconspan = "<span class=\"icon "+item.iconCls+"\"></span>";
	$(_iconspan).addClass(item.iconCls).prependTo(node);
	/*if(item.title=="楼盘信息管理"){$("<span class=\"icon icon-hou\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="资讯管理"){$("<span class=\"icon icon-news\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="图片管理"){$("<span class=\"icon icon-icons\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="意向管理(经纪人)"){$("<span class=\"icon icon-pur\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="客户管理(经纪人)"){$("<span class=\"icon icon-agent\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="客户意向审核(管理员)"){$("<span class=\"icon icon-check\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="客户审核(管理员)"){$("<span class=\"icon icon-users\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="客户审核(开发商)"){$("<span class=\"icon icon-developer\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="佣金结算"){$("<span class=\"icon icon-money\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="客户统计"){$("<span class=\"icon icon-users\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="经纪人管理"){$("<span class=\"icon icon-agent\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="开发商管理"){$("<span class=\"icon icon-developer\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="系统管理员"){$("<span class=\"icon icon-role\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="用户管理"){$("<span class=\"icon icon-users\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="菜单管理"){$("<span class=\"icon icon-tree\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="权限管理"){$("<span class=\"icon icon-role\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="角色授权"){$("<span class=\"icon icon-roleset\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="账号设置"){$("<span class=\"icon icon-set\"></span>").addClass(item.iconCls).prependTo(node);}
if(item.title=="职业资质认证"){$("<span class=\"icon icon-work\"></span>").addClass(item.iconCls).prependTo(node);}*/
...
opts.tab.append("<a href=\"javascript:void(0)\" class=\"tabs-inner\">"+"<span class=\"tabs-title\"></span>"+"<span class=\"icon\" style=\"float:left;margin-top:4px; \"></span>"+"</a>");
...
var _2f6=tab.find("span.icon");
_2f5.html(opts.title);
_2f6.attr("class","icon");
...
},message:"Please enter a value bettween {0} and {1}.."},remote:{validator:function(_40c,_40d){
var data={};
data[_40d[1]]=_40c;
