...
<%
	...
	if(tableName == null){
		tableName = session.getAttribute("NoticeTable")+"";
	}
...
%>
	<div id="contentRight" style="width: 100%; height: 440px; font-size: 14px; margin-left: 0px; margin-bottom: 0px; border: 1px solid #DDDDDD; overflow: scroll;">
		<form action="/saveNoticeResult" id="">
			请输入提醒名称：<input type="text"  name="noticeName" value="提醒名称"/>
			请输入提醒时间：<input type="text"  name="noticeTime" value="2015-01-01"/>
			<input type="submit" class="btn btn-success" name="" id="" value="保存提醒结果"/>
