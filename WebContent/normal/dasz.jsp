...
<body>
	...
	<div class="inline pull-right page">
      	 ...
      	 <%
      	 if(current > 1){
      		 %> &nbsp;<a href='normalDaszServlet?tableName=personal&current=<%= current - 1%>'>上一页</a><%
      	 }
      	 %>
      	 <%
      	 if(current < pageCount){
      		 %> &nbsp;<a href='normalDaszServlet?tableName=personal&current=<%= current + 1%>'>下一页</a><%
      	 }
      	 %>
         &nbsp;<a href='normalDaszServlet?tableName=personal&current=<%= pageCount %>' >最后一页</a> 
         <form action="normalDaszServlet?tableName=personal" method="post">
