...
@WebServlet("/jlszModRowRequest")
public class JlszModRowRequest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/jsp/rssz/jlsz/modRow.jsp").forward(request, response);
	}
