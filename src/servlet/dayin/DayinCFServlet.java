...
/**
 * Servlet implementation class DayinCFServlet
 */
@WebServlet("/dayinCFServlet")
public class DayinCFServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/jsp/dayin/rsbdcp.jsp?tableName=personal").forward(request, response);
	}
