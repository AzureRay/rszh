...
@WebServlet("/getGJCXtj")
public class GetGJCXtj extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getSession().setAttribute("GJCXtableName", tableName);
		...
		request.getSession().setAttribute("GJCXsql", sql);
