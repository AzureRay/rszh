...
/**
 * Servlet implementation class NormalRsbdServlet
 */
@WebServlet("/normalRsbdServlet")
public class NormalRsbdServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/normal/rsbd.jsp?tableName=personal").forward(request, response);
	}
