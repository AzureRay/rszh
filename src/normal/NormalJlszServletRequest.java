...
/**
 * Servlet implementation class NormalJlszServletRequest
 */
@WebServlet("/normalJlszServletRequest")
public class NormalJlszServletRequest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/normal/rsjl.jsp?tableName="+tableName).forward(request, response);
	}
}
