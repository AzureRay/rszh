...
/**
 * Servlet implementation class NormalShowPersonal
 */
@WebServlet("/normalShowPersonal")
public class NormalShowPersonal extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/normal/showPersonal.jsp?pageCount="+pageCount).forward(request, response);
	}
