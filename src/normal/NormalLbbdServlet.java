...
/**
 * Servlet implementation class NormalLbbdServlet
 */
@WebServlet("/normalLbbdServlet")
public class NormalLbbdServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/normal/lbbd.jsp?tableName=personal").forward(request, response);
	}
}
