...
public class NoticeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getSession().setAttribute("NoticeTable", tableName);
		...
		request.getSession().setAttribute("NoticeResult", list);
		request.getRequestDispatcher("/notice/showNotice.jsp").forward(request, response);
	}
